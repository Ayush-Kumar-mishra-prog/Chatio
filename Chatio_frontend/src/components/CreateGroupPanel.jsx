      ...
      {step === "members" ? (
          ...
          <div className="flex-1 overflow-y-auto">
            {filteredContacts.map((user) => {
              ...
              return (
                ...
                >
                  <img
                    src={user.image || user.profilePic || assets.avatar_icon}
                    alt=""
                  ...
                  <span
                    className={`h-5 w-5 rounded-full border grid place-items-center ${selected ? "bg-[#00a884] border-[#00a884] text-white" : "border-slate-300"}`}
                  >
        ...
        <div className="p-5 space-y-6">
          <div className="flex items-center gap-4">
            <button
              type="button"
              className="h-16 w-16 rounded-full bg-[#e9edef] text-[#075e54] grid place-items-center"
            >
          ...
          <button
            ...
            className="w-full rounded-full bg-[#00a884] py-3 text-sm font-semibold text-white disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {isCreating ? (
              <>
